...
(() => {
    ...
    (() => {
        ...
        var e = {};
        r.r(e), r.d(e, {
            countSelectorsByStatus: () => te,
            getCachedResolvers: () => Z,
            getIsResolving: () => $,
            getResolutionError: () => Q,
            getResolutionState: () => B,
            hasFinishedResolution: () => q,
            hasResolutionFailed: () => J,
            hasResolvingSelectors: () => ee,
            hasStartedResolution: () => X,
            isResolving: () => Y
        });
        var t = {};
        r.r(t), r.d(t, {
            ...
            failResolutions: () => ce,
            finishResolution: () => ne,
            finishResolutions: () => ie,
            invalidateResolution: () => ue,
            invalidateResolutionForStore: () => ae,
            invalidateResolutionForStoreSelector: () => le,
            startResolution: () => re,
            startResolutions: () => se
        });
        var o = {};
        ...
        function v() {
            ...
            return function(e) {
                return function() {
                    ...
                    return n = h.apply(void 0, s)(r.dispatch), l(l({}, r), {}, {
                        dispatch: n
                    })
                }
            }
        ...
        var S = r(3249),
            m = r.n(S);
        const O = window.wp.reduxRoutine;
        var w = r.n(O);
        ...
        const V = (G = "selectorName", e => (t = {}, r) => {
            ...
            switch (t.type) {
                ...
                case "START_RESOLUTIONS":
                    {
                        const r = new(m())(e);
                        for (const e of t.args) r.set(C(e), {
                            status: "resolving"
                        });
                        return r
                    }
        ...
        function X(e, t, r) {
            return void 0 !== B(e, t, r)
        }

        function q(e, t, r) {
            const n = B(e, t, r) ? .status;
            return "finished" === n || "error" === n
        }

        function J(e, t, r) {
            return "error" === B(e, t, r) ? .status
        }
        ...
        function Y(e, t, r) {
            return "resolving" === B(e, t, r) ? .status
        }
        ...
        const te = function(e, t) {
            ...
            function s() {
                var t, o, s, i, c, u = arguments.length;
                ...
                for (t = function(e) {
                        ...
                        return c.has(W) || ((s = function() {
                            ...
                            return e
                        }()).isUniqueByDependants = u, c.set(W, s)), c.get(W)
                    }(c = n.apply(null, i)), t.isUniqueByDependants || (t.lastDependants && !z(c, t.lastDependants, 0) && t.clear(), t.lastDependants = c), o = t.head; o;) {
        ...
        const fe = e => {
            ...
            pe = (e, t) => Object.fromEntries(Object.entries(null != e ? e : {}).map((([e, r]) => [e, t(r, e)]))),
            ge = (e, t) => t instanceof Map ? Object.fromEntries(t) : t;
                ...
                c = {
                    ...
                    instantiate: c => {
                        const u = new Set,
                            ...
                            l = function(e, t, r, n) {
                                const o = { ...t.controls,
                                    ...
                                    s = pe(o, (e => e.isRegistryControl ? e(r) : e)),
                                    i = [D(r, e), U, w()(s), k(n)],
                                    c = [v(...i)];
                        ...
                        const f = function() {
                            const e = {};
                            return {
                                isRunning: (t, r) => e[t] && e[t].get(fe(r)),
                                clear(t, r) {
                                    e[t] && e[t].delete(fe(r))
                                },
                                markAsRunning(t, r) {
                                    e[t] || (e[t] = new(m())), e[t].set(fe(r), !0)
                                }
                            }
                        }();
                        ...
                        function O(e, t) {
                            ...
                            return n ? function(e, t, r, n, o) {
                                function s(e) {
                                    ...
                                    X(i, t, e) || (o.markAsRunning(t, e), setTimeout((async () => {
                                        o.clear(t, e), n.dispatch(re(t, e));
                                        try {
                                            const o = r.fulfill(...e);
                                            o && await n.dispatch(o), n.dispatch(ne(t, e))
                                        } catch (r) {
                                            n.dispatch(oe(t, e, r))
                                        }
                                    }), 0))
                                }
                                const i = (...t) => (s(t = be(e, t)), e(...t));
                                return i.hasResolver = !0, i
                            }(r, t, n, l, f) : (r.hasResolver = !1, r)
                        }
                        const _ = { ...pe(e, (function(e) {
                                    const t = (...t) => {
                                        const r = l.__unstableOriginalGetState(),
                                            o = t && t[0],
                                            s = t && t[1],
                                            i = n ? .selectors ? .[o];
                                        return o && i && (t[1] = be(i, s)), e(r.metadata, ...t)
                                    };
                        ...
                        const j = function(e, t) {
                                ...
                                return pe(p, ((r, n) => r.hasResolver ? (...o) => new Promise(((s, i) => {
                            ...
                            A = function(e, t) {
                                return pe(e, ((r, n) => r.hasResolver ? (...o) => {
                        ...
                        const M = l && (e => (u.add(e), () => u.delete(e)));
        ...
        function me(e = {}, t = null) {
            ...
            let u = {
                ...
                registerGenericStore: function(e, t) {
                    i()("wp.data.registerGenericStore", {
                        since: "5.9",
                ...
                registerStore: function(e, t) {
                    ...
                    return c(e, (() => de(e, t).instantiate(u))).store
                },
            ...
            u.register(he);
            for (const [t, r] of Object.entries(e)) u.register(de(t, r));
            t && t.subscribe(s);
        ...
        let je;
        try {
            je = window.localStorage, je.setItem("__wpDataTestLocalStorage", ""), je.removeItem("__wpDataTestLocalStorage")
        } catch (e) {
            je = Ne
        }
        const Ae = je,
                ...
                registerStore(t, n) {
                    ...
                    return s.subscribe(function(e, t, n) {
                        ...
                        if (Array.isArray(n)) {
                            ...
                            s = ct(e), o = (e, t) => t.nextState === e ? e : s(e, t)
        ...
        var ke = r.n(De);
        const Ce = (0, Ue.createContext)(Oe),
            {
                Consumer: Ve,
                Provider: Ge
            } = Ce,
        ...
        function Je(e, t) {
            ...
            return (t, f) => {
                        ...
                        c = (t => {
                            ...
                            return {
                                subscribe: function(t) {
                                    if (u)
                                        for (const e of r) a.get(e) !== l(e) && (u = !1);
                                    a.clear();
                                    const s = () => {
                                            u = !1, t()
                                        },
                ...
                return i && !f && (u = !1, qe.cancel(n)), p(), i = f, {
        ...
        const et = e => (0, R.createHigherOrderComponent)((t => (0, R.pure)((r => {
                const n = Ye(((t, n) => e(t, r, n)));
                return (0, xe.createElement)(t, { ...r,
                    ...n
                })
            }))), "withSelect"),
            tt = (e, t) => {
            ...
            rt = e => (0, R.createHigherOrderComponent)((t => r => {
                const n = tt(((t, n) => e(t, r, n)), []);
                return (0, xe.createElement)(t, { ...r,
                    ...n
                })
            }), "withDispatch"),
            nt = (0, R.createHigherOrderComponent)((e => t => (0, xe.createElement)(He, null, (r => (0, xe.createElement)(e, { ...t,
                registry: r
            })))), "withRegistry"),
            ot = e => {
                const {
