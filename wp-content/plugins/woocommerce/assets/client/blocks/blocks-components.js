(() => {
                ...
                e.exports = function() {
                    ...
                    return function t() {
                        ...
                        return r.sanitize = function(t) {
                            ...
                            if (Fe || dt(p), r.removed = [], "string" == typeof t && (Ke = !1), Ke) {
                                if (t.nodeName) {
                                    var m = ge(t.nodeName);
                            ...
                            for (var f = Et(Ke ? t : o); l = f.nextNode();) 3 === l.nodeType && l === u || Nt(l) || (l.content instanceof s && Tt(l.content), At(l), u = l);
                            if (u = null, Ke) return t;
                            if (He) {
                                if (Ve)
    ...
    (() => {
        ...
        n.r(o), n.d(o, {
            ...
            TotalsTaxes: () => zt,
            TotalsWrapper: () => Jt,
            ValidatedTextInput: () => Gt,
            ValidationInputError: () => Ft
        });
        ...
        const B = (0, a.forwardRef)((({
            ...
            const G = (0, a.useRef)(null),
                Z = (0, a.useRef)(null),
                j = (0, a.useRef)(),
                K = (0, d.useViewportMatch)("medium", "<"),
                [W, z] = (0, a.useState)(),
                Y = w(_),
                J = S && K,
                [q, Q] = (0, d.useResizeObserver)();
            i = J || i, (0, a.useLayoutEffect)((() => {
                if (J) return F(j.current, "is-without-arrow", i), F(j.current, "is-alternate", l), I(j.current, "data-x-axis"), I(j.current, "data-y-axis"), P(j.current, "top"), P(j.current, "left"), P(Z.current, "maxHeight"), void P(Z.current, "maxWidth");
                const e = () => {
                    ...
                    var a;
                    L && (o = null === (a = j.current.closest(".popover-slot")) || void 0 === a ? void 0 : a.parentNode);
                    const s = Q.height ? Q : Z.current.getBoundingClientRect(),
                        ...
                        }(e, s, c, k, j.current, r, o, B, H);
                    "number" == typeof u && "number" == typeof d && (P(j.current, "top", u + "px"), P(j.current, "left", d + "px")), F(j.current, "is-without-arrow", i || "center" === m && "middle" === f), F(j.current, "is-alternate", l), I(j.current, "data-x-axis", m), I(j.current, "data-y-axis", f), P(Z.current, "maxHeight", "number" == typeof v ? v + "px" : ""), P(Z.current, "maxWidth", "number" == typeof E ? E + "px" : ""), z(({
                        left: "right",
                        right: "left"
                    }[m] || "center") + " " + ({
                        top: "bottom",
        ...
        const H = B,
            ...
            K = function({
                ...
                const [r, i] = (0, a.useState)(!1), [s, c] = (0, a.useState)(!1), u = (0, d.useDebounce)(c, 700), p = t => {
                    j(e, "onMouseDown", t), document.addEventListener("mouseup", h), i(!0)
                }, m = t => {
                    j(e, "onMouseUp", t), document.removeEventListener("mouseup", h), i(!1)
                }, f = e => "mouseUp" === e ? m : "mouseDown" === e ? p : void 0, h = f("mouseUp"), g = (t, n) => o => {
                    if (j(e, t, o), o.currentTarget.disabled) return;
            ...
            X = (0, a.forwardRef)((function(e, t) {
                ...
                return L ? (0, a.createElement)(a.Fragment, null, (0, a.createElement)(K, {
                    text: A || b,
                    shortcut: E,
                    position: C
        ...
        const nt = window.wp.htmlEntities,
            ot = ({
                ...
                return (0, e.createElement)("div", {
                    ...
                    return 1 === o.length ? (0, e.createElement)(Ke, { ...i
                    }, (0, e.createElement)(a.RawHTML, null, n[0].content)) : (0, e.createElement)(Ke, { ...i,
            ...
            mt = function(n) {
                ...
                return r.componentDidMount = function() {
                    ...
                    var o, r, a = n.children,
                        i = n.handleExited;
                    return {
                        children: n.firstRender ? (o = t, r = i, ct(o.children, (function(t) {
                            return (0, e.cloneElement)(t, {
                                onExited: r.bind(null, t),
                                in: !0,
                                appear: ut(t, "appear", o),
                                enter: ut(t, "enter", o),
                                exit: ut(t, "exit", o)
                            })
                        }))) : dt(t, a, i),
                    ...
                    var e = this.props,
                        ...
                        i = pt(this.state.children).map(o);
                    return delete r.appear, delete r.enter, delete r.exit, null === n ? t().createElement(lt.Provider, {
                        value: a
                    }, i) : t().createElement(lt.Provider, {
                        value: a
                    }, t().createElement(n, r, i))
                }, o
            }(t().Component);
        mt.propTypes = {}, mt.defaultProps = {
            component: "div",
        ...
        var yt = function(e) {
            ...
            St = function(e) {
                function n(t, n) {
                    ...
                    return o.appearStatus = null, t.in ? a ? (r = Et, o.appearStatus = bt) : r = wt : r = t.unmountOnExit || t.mountOnEnter ? Ct : Et, o.state = {
                        status: r
                    }, o.nextCallback = null, o
                }
                st(n, e), n.getDerivedStateFromProps = function(e, t) {
                ...
                return o.componentDidMount = function() {
                    ...
                    if (e !== this.props) {
                        ...
                        this.props.in ? n !== bt && n !== wt && (t = bt) : n !== bt && n !== wt || (t = Nt)
                    }
                    ...
                    if (void 0 === e && (e = !1), null !== t)
                        if (this.cancelNextCallback(), t === bt) {
                            if (this.props.unmountOnExit || this.props.mountOnEnter) {
                                var n = this.props.nodeRef ? this.props.nodeRef.current : vt().findDOMNode(this);
                                n && yt(n)
                            }
                            this.performEnter(e)
                    ...
                    var t = this,
                        ...
                        r = this.props.nodeRef ? [o] : [vt().findDOMNode(this), o],
                        a = r[0],
                        i = r[1],
                        s = this.getTimeouts(),
                    ...
                    var e = this,
                        t = this.props.exit,
                        n = this.getTimeouts(),
                        o = this.props.nodeRef ? void 0 : vt().findDOMNode(this);
                    ...
                    return t().createElement(lt.Provider, {
                        value: null
        ...
        function xt() {}
        St.contextType = lt, St.propTypes = {}, St.defaultProps = { in: !1,
            mountOnEnter: !1,
            unmountOnExit: !1,
            appear: !1,
            enter: !0,
            ...
            onExiting: xt,
            onExited: xt
        }, St.UNMOUNTED = Ct, St.EXITED = Et, St.ENTERING = bt, St.ENTERED = wt, St.EXITING = Nt;
        const At = St;
        var Tt = function(e, t) {
                return e && t && t.split(" ").forEach((function(t) {
                    return o = t, void((n = e).classList ? n.classList.remove(o) : "string" == typeof n.className ? n.className = ht(n.className, o) : n.setAttribute("class", ht(n.className && n.className.baseVal || "", o)));
                    var n, o
                }))
            },
            kt = function(e) {
                ...
                return o.addClass = function(e, t, n) {
                    ...
                    "appear" === t && "done" === n && r && (o += " " + r), "active" === n && e && yt(e), o && (this.appliedClasses[t][n] = o, function(e, t) {
                    ...
                    var n = this.appliedClasses[t],
                        ...
                        r = n.active,
                        a = n.done;
                    this.appliedClasses[t] = {}, o && Tt(e, o), r && Tt(e, r), a && Tt(e, a)
                }, o.render = function() {
                    var e = this.props,
                        n = (e.classNames, rt(e, ["classNames"]));
                    return t().createElement(At, at({}, n, {
        ...
        const Rt = ({
            ...
            Mt = ({
                ...
                return (0, e.createElement)("div", {
                    ...
                    return (0, e.createElement)(Rt, { ...o,
                        onRemove: s(t),
                        listRef: r,
                        key: t.id
                    }, t.content)
                })) : (0, e.createElement)(ft, null, t.map((t => {
                    const {
                        content: n,
                        ...o
                    } = t;
            ...
            Dt = ({
                ...
                const {
                    ...
                    return [...u.flatMap((e => Ot(t(e), e))), ...c.flatMap((e => Ot(t(e).concat(o), e)))].filter(Boolean)
                }));
        ...
        const Vt = new Map([
            ...
            Ut = (new Map([...Ht.O, ...Vt]), (0, a.forwardRef)((({
                className: t,
                id: n,
                type: o = "text",
                ariaDescribedBy: r,
                ...
                const [E, b] = (0, a.useState)(!0), w = tt(p), N = (0, a.useRef)(null), S = (0, d.useInstanceId)(Ut, "", v), x = void 0 !== n ? n : "textinput-" + S, A = void 0 !== i ? i : x, {
                ...
                const {
                    ...
                    null !== t && (t.value = t.value.trim(), t.setCustomValidity(""), t.checkValidity() && R.current(t) ? _(A) : T({
                        [A]: {
                            message: h ? Bt(h, t) : t.validationMessage,
                            hidden: e
                        }
                    }))
                }), [_, A, T, h]);
                ...
                return (0, e.createElement)(It, {
                    ...
                    id: x,
                    type: o,
                    feedback: c ? (0, e.createElement)(Pt, {
                        errorMessage: u,
                        propertyName: A
                    }) : null,
                    ref: N,
        ...
        const Zt = ({
            ...
            zt = ({
                ...
                return s ? l : (0, e.createElement)(e.Fragment, null, (0, e.createElement)(jt, {
                    className: Q()("wc-block-components-totals-taxes", o),
                    currency: t,
